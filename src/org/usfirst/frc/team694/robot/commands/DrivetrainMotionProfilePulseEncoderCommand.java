 ...
 *
 */
public class DrivetrainMotionProfilePulseEncoderCommand extends Command {
    ...
    public DrivetrainMotionProfilePulseEncoderCommand(String nameOfPath, double dt) {
    	requires(Robot.drivetrain);
    	leftCSV = new File("/home/lvuser/Paths/" + nameOfPath + "_left_Pulse.csv");
    	rightCSV = new File("/home/lvuser/Paths/" + nameOfPath + "_right_Pulse.csv");
